...
insert into Student(id,name,mark1,mark2,mark3,total,result,dob) values
	...
	insert into Student(id,name,mark1,mark2,mark3,total,result,dob) values
	(105,'Rama',30,30,30,90,'Pass','1999-03-03');
...
select DATEADD(Month,0,dob) as 'mydate'
from Student


select DATEADD(day,1,dob) as 'mydate'
from Student
...
insert into Student(id,name,departmentID) values
(109,'Shyam',999);
